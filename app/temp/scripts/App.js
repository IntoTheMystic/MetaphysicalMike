...
/***/ (function(module, exports, __webpack_require__) {
	...
	function startAnimate() {
	  ...
	  setTimeout(function () {
	    ...
	    (0, _jquery2.default)('.section1__title').removeClass('animate');
	  }, 500);
	};
	...
	(0, _jquery2.default)('.header__togglebutton').click(function () {

	  (0, _jquery2.default)('.header__my_nav').toggleClass('open');
	});

	var current = document.querySelector('#current-img');
	var images = document.querySelectorAll('.my-work__gallery__img img');
	...
	var squarebutton = (0, _jquery2.default)('#squarebutton');
	...
	window.onload = function () {
	  _jquery2.default.get('dupa.json').then(function (dupa) {
	    console.log(dupa);
	    return _jquery2.default.get('niemapracy.json');
	  }).then(function (niemapracy) {
